...
public class AddTask extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Duration in hrs");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Task tmp = new Task();
        tmp.TaskID=Integer.parseInt(jTextField2.getText());
        tmp.TName=jTextField3.getText();
        tmp.Emp=Main.Employes.get(Integer.parseInt(jTextField4.getText()));
        tmp.Duration=Float.parseFloat(jTextField5.getText());
        tmp.ProID=PNum;
        Project p= Main.Projects.get(PNum);
        p.Tasks.add(tmp);
        Main.Projects.put(PNum,p);
        Employ E = new Employ();
        E=Main.Employes.get(tmp.Emp.EmID);
        E.NumofTasks=E.NumofTasks+1;
        Main.Employes.put(tmp.Emp.EmID, E);
        setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddTask(PNum).setVisible(true);
            }
        });
    }
